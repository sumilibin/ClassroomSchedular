...
import { editTeacherData } from "../../Services/user-service";

function TeacherEdit({ rows, selectedRow, setRows, setIsEditing }) {
  const teacher_id = selectedRow.teacher_id;
  console.log("Teacher Edit",selectedRow);
